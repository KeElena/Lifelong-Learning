...
func (c *userClient) CreateUser(ctx context.Context, in *IdRequest, opts ...grpc.CallOption) (*Info, error) {
	out := new(Info)
...
type UserServer interface {
	CreateUser(context.Context, *IdRequest) (*Info, error)
...
func (UnimplementedUserServer) CreateUser(context.Context, *IdRequest) (*Info, error) {
...
func _User_CreateUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).CreateUser(ctx, req.(*IdRequest))
	}
